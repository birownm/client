...
const sttaddr = "0x3b5b8c50256c8bb43944f192d8d8f048a121d9b9";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x3b5b8c50256c8bb43944f192d8d8f048a121d9b9";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://birow.net/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'ERC20',
                'options': {
                    'address': '0x3b5b8c50256c8bb43944f192d8d8f048a121d9b9',
                    'symbol': 'BIRO',
                    'decimals': '18',
                    'image': 'https://Birow.net/assets/images/logo.png',
                },
            },
